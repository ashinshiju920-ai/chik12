        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-[#8A8478]">
          ...
          <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-4 flex-wrap justify-center sm:justify-end gap-y-2">
            ...
            <div className="flex items-center gap-2 flex-wrap justify-center">
              ...
              <div className="px-2.5 py-1 bg-[#120F24] border border-[#2A2347] rounded-xs flex items-center h-7 shadow-xs">
                <img src="/cashfree-payments.png" alt="Cashfree Payments" className="h-4 w-auto object-contain" />
              </div>
            </div>
          </div>
        </div>
